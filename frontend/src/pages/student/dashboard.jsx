        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <div className="mt-4">
                <Link to="/student/subjects" className="text-sm text-blue-600 hover:text-blue-800 font-medium">
                  View all subjects →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <div className="mt-4">
                <Link to="/student/results" className="text-sm text-green-600 hover:text-green-800 font-medium">
                  View results →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <div className="mt-4">
                <Link to="/student/files" className="text-sm text-yellow-600 hover:text-yellow-800 font-medium">
                  Access files →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <div className="mt-4">
                <Link to="/student/notifications" className="text-sm text-red-600 hover:text-red-800 font-medium">
                  View all →
                </Link>
              </div>
            </div>
